...
function getColor(d) {
 return  d < 0.43 | d == "0.37-0.42"  ? '#800026' :
         d < 0.48 | d == "0.42-0.47" ? '#BD0026' :
         d < 0.53 | d == "0.47-0.52" ? '#E31A1C' :
         d < 0.67 | d == "0.52-0.67" ? '#000000' :
                             '#FFEDA0';
}
...
categories = ["0.37-0.42","0.42-0.47","0.47-0.52","0.52-0.67",'Other'];
