...
function getColor(d) {
 return  d < 1.38 | d == "1.18-1.38" ? '#00c2c7' :
         d < 2.2 | d == "1.38-2.19"  ? '#0086ad' :
         d < 3.4 | d == "2.19-3.39" ? '#005582' :
         d < 5.93 | d == "3.39-5.92"  ? '#000000' :
                             '#FFEDA0';
}
...
categories = ["1.18-1.38","1.38-2.19","2.19-3.39","3.39-5.92",'Other'];
