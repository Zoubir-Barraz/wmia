...
function getColor(d) {
    return (d <= 20447 & d >= 16204) | d == '16204-20447' ? '#b2d8d8' :
        (d <= 27381 & 20448 < d) | d == '20448-27381' ? '#66b2b2' :
            (d <= 42869 & 27382 <= d) | d == '27382-42869' ? '#008080' :
                '#FFEDA0';
}
...
legend.onAdd = function (map) {
    ...
    labels = ['<strong>PIB par habitant (DH)</strong>'],
        categories = ['16204-20447', '20448-27381', '27382-42869', 'Other'];
