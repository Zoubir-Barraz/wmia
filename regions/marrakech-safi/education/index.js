...
function getColor(d) {
 return  d == 0.451 | d == "0.451"  ? '#fe8181' :
         d < 0.56 | d == "0.452-0.559"   ? '#fe2e2e' :
         d < 0.639 | d == "0.560-0.639"  ? '#b62020' :
         d < 0.702 | d == "0.640-0.701"  ? '#000000' :
                             '#FFEDA0';
}
...
categories = ["0.451","0.452-0.559","0.560-0.639","0.640-0.701",'Other'];
