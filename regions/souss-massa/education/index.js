...
function getColor(d) {
    return (0.453 < d & d < 0.483) | d == "0.453-0.483" ? '#fee6ce' :
            (0.484 < d & d < 0.581) | d == "0.484-0.581" ? '#fdae6b' :
            (0.582 < d & d < 0.606) | d == "0.582-0.606" ? '#e6550d' :
                                    '#FEB24C';
}
...
legend.onAdd = function (map) {
    ...
    labels = ['<strong>Indice de Gini de lՎducation en 2014</strong>'],
        categories = ["0.453-0.483", "0.484-0.581", "0.582-0.606", 'Other'];
